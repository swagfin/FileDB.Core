...
namespace FileDB.Core
{
    ...
    public partial class DB : IDisposable
    {
        ...
        public DB(string fileName, FileAccess fileAccess)
        {
        ...
        public void Shrink()
        {
            ...
            DB.CreateEmptyFile(tempFile, false);

            using (var tempDb = new DB(tempFile, FileAccess.ReadWrite))
            {
